...
ax1.pie(results['Total Duration (min)'], colors = colors, \
...
colors = ['#ff9999','#66b3ff','#99ff99','#ffcc99']
fig1, ax1 = plt.subplots(figsize = (5.5, 5.5))
ax1.pie([Denial_Rate_Transfers, Approval_Rate_Transfers], labels = labels, \
...
colors = ['#ff9999','#66b3ff','#99ff99','#ffcc99']
fig1, ax1 = plt.subplots(figsize = (5.5, 5.5))
ax1.pie([Denial_Rate_Requests, Approval_Rate_Requests], \
