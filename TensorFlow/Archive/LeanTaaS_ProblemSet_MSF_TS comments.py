# all my comments in the notebook apply here.
# make sure to put all your functions at the top and then your logic flow (order of calling them)
# at the bottom of the script.
# I'm assuming this is a WIP, but make sure that the script outputs the right files (e.g., png files etc.),
# visualization wont work if you call the script directly. 
